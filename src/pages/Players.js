        ...
        action={
          <div style={{display:'flex',gap:8,alignItems:'center'}}>
            ...
            <ExportMenu
              ...
              columns={[
                { key: 'fullName',         label: '🏃‍♂️' },
                { key: 'gender',           label: 'G' },
                { key: 'dob',              label: '🗓️' },
                { key: 'nationalities',    label: '🌎' },
                { key: 'primaryPosition',  label: '📍' },
                { key: 'secondaryPositions', label: 'Sec 📍',
                  format: (v) => Array.isArray(v) ? v.join(', ') : (v || '') },
                { key: 'foot',             label: '🦵' },
                { key: 'currentClub',      label: '🔰',
                  format: (v, r) => r.contractStatus === 'Free'
                    ? 'Free Agent'
                    : (v ? `${v}${r.currentClubIsYouth ? ' (U19)' : ''}${r.league ? `  ·  ${r.league}` : ''}` : '') },
                { key: 'contractStatus',   label: '📑' },
                { key: 'contractEnd',      label: 'End 📑' },
                { key: 'reprEnd',          label: 'End 🤝' },
                { key: 'passportExpiry',   label: 'End 🪪' },
                { key: 'natTeamStatus',    label: '🏟️' },
