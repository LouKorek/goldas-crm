                      ...
                      <td style={{fontWeight:600}}>
                        ...
                        {(p.profileLink || p.videoLink) && (
                          <div style={{display:'flex',gap:6,marginTop:3}}>
                            ...
                            {p.videoLink && (
                              <a href={p.videoLink} target="_blank" rel="noopener noreferrer"
                ...
                {form.leagueMode==='select' ? (
                  <div className="form-grid-2">
                    <select value={f('leagueCountry')} onChange={e=>s('leagueCountry')(e.target.value)}>
                      ...
                      {['Israel','England','Spain','Germany','Italy','France','Portugal','Netherlands','Belgium','Turkey','Greece','Switzerland','Scotland','Russia','Ukraine','Serbia','Croatia','Czech Republic','Poland','Romania','Bulgaria','Argentina','Brazil','USA','Mexico'].map(c=><option key={c}>{c}</option>)}
                    </select>
